...
def pause_screen():
    ...
    gamestate.screen.blit(paused_text_line2,(constants.SCREEN_WIDTH//2 - pygame.Surface.get_width(paused_text_line2)//2, constants.SCREEN_HALF_HEIGHT + constants.paused_font.get_linesize()))